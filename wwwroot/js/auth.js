...
const AuthService = {
    ...
    hasRole(role) {
        ...
        try {
            ...
            // Look for role claims in different possible formats
...
function updateAuthUI() {
    if (AuthService.isAuthenticated()) {
        ...
        if (AuthService.hasRole('Admin') && adminPanel) {
            ...
            bookingContainer.style.display = 'none'; // Hide regular booking container for admins
            ...
            console.log('User is not admin, showing regular booking container');
            if (adminPanel) {
                adminPanel.style.display = 'none';
            }
            bookingContainer.style.display = 'block';

            // Load bookings when authenticated for regular users
