...
const MemberModule = (() => {
    ...
    const handleSaveBooking = async (e) => {
        ...
        const bookingData = {
            ...
            bookingStatus: 'Pending', // Members can only create pending bookings
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                App Module.showNotification(`Failed to delete booking: ${errorData.message || 'Unknown error'}`, 'error');
            }
        } catch (error) {
